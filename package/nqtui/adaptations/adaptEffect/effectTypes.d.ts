...
export type EffectFn<T = any, U extends any[] = any[]> = (returnValue?: T, argsArray?: U) => (() => T) | void;
export type DepArray<U extends any[] = any[]> = {
    [I in keyof U]: Getter<U[I]>;
};
export type ExecuteFn = <T = any, U extends any[] = any[]>(effect: InternalEffectObject, fn: EffectFn<T, U>, depArray?: DepArray<U>, options?: EffectOptions) => () => void;
